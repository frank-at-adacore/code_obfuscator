...
package body Cli is
   ...
   function From_String (Source : String) return Unbounded_String
   ...
   procedure Action_Clear_Strings (Param : String := "");
   ...
   procedure Action_Externally_Built (Param : String := "");
   ...
   procedure Action_Recursive (Param : String := "");
   ...
   function Convert (Source : String) return String_Set_T;
   ...
   procedure Action_Clear_Strings (Param : String := "") is
   begin
   ...
   procedure Action_Externally_Built (Param : String := "") is
   begin
   ...
   procedure Action_Recursive (Param : String := "") is
   begin
   ...
   function Argument return String is
      (To_String (Global_Argument));

   -------------------
   -- Clear_Strings --
   -------------------

   function Clear_Strings return Boolean is
      (Global_Clear_Strings);
   ...
   function Destination return String is
      (To_String(Global_Destination));

   ----------------- --
   -- Excluded_Paths --
   ----------------- --

   function Excluded_Paths return String_Set_T is
   ...
   function Externally_Built return Boolean is
      (Global_Externally_Built);

   -------------------
   -- Min_Length    --
   -------------------

   function Min_Length return Positive is
      (Global_Min_Length);
   ...
   function Skipped_Units return String_Set_T is
      (Global_Skipped_Units);

   ---------------------
   -- Constant_Length --
   ---------------------

   function Constant_Length return Natural is
      (Global_Constant_Length);
     ...
     [1 =>
      ...
      3  =>
       (Switch      => From_String ("u"),
        ...
        Help        => From_String ("Comma-separated list of units (and children) to exclude")),
     4  =>
       (Switch      => From_String ("p"),
        Long_Switch => From_String ("excluded_paths"),
        With_Param  => True,
        Action      => Action_Excluded_Paths'Access,
        Help        => From_String ("Comma-separated list of file path prefixes to skip")),
      5  =>
     ...
     6  =>
      ...
      7  =>
       (Switch      => From_String ("k"),
        ...
        Help        => From_String ("If specified, string literals will not be obfuscated")),
      8  =>
       (Switch      => From_String ("r"),
        Long_Switch => From_String ("recursive"),
        With_Param  => False,
        Action      => Action_Recursive'Access,
        Help        => From_String ("If specified, imported projects will be traversed")),
      9  =>
       (Switch      => From_String ("b"),
        Long_Switch => From_String ("external"),
        With_Param  => False,
        Action      => Action_Externally_Built'Access,
        Help        => From_String ("If specified, externally built projects will be traversed"))];
   ...
   begin
      ...
      for Switch of Global_Switch_Definitions
      loop
         declare
   ...
   begin
      ...
      if Element /= Switch_Map.No_Element
      then
   ...
   begin
      ...
      declare
         ...
         Argument : constant String := Get_Argument (End_Of_Arguments => End_Of_Arguments);
      begin
   ...
   function Convert (Source : String) return String_Set_T is
